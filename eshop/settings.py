...
MIDDLEWARE = [
    ...
    'middleware.current_request.ConditionalSSLRedirectMiddleware',  # our new middleware
...
SITE_ID = 1
LOGIN_REDIRECT_URL = '/accounts/profile_creation/'  # Redirect users after successful login
